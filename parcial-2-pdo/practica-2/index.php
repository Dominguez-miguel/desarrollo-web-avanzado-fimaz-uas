...
<html lang="es">
    ...
    <body>
        <h2>Praactica: try/catch y transacciones (PDO + MySQL)</h2>
        ...
        <div class="card">
            <form method="POST">
                ...
                <div class="row">
                    <div>
                        <label>Nombre</label>
                        <input type="text" name="nombre" maxlength="15" value="<?= htmlspecialchars($_POST['nombre'] ?? 'Francisco Miguel') ?>">
                    </div>
                    <div>
                        <label>Apellido</label>
                        <input type="text" name="apellido" maxlength="10" value="<?= htmlspecialchars($_POST['apellido'] ?? 'Dominguez Davalos') ?>">
                    </div>
                    <div>
                        <label>Correo</label>
                        <input type="email" name="correo" maxlength="50" value="<?= htmlspecialchars($_POST['correo'] ?? 'miguel@hotmail.com') ?>">
                    </div>
                </div>
        ...
        <p claass="small">Prueba recomendada: 1. Registrar sin simular error (COMMIT). 2. Activar "Simular error" y registrar (ROLLBACK).</p>
    </body>
    </html>
