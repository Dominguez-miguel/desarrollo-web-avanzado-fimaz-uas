...
<form action="index.php?route=productos/update" method="POST">
    ...
    <div class="mb-3">
        ...
        <input type="number" step="0.01" name="precio_compra" class="form-control" value="<?= htmlspecialchars($producto['precio_compra']); ?>" required>
    </div>

    <div class="mb-3">
        <label class="form-label">Precio venta</label>
        <input type="number" step="0.01" name="precio_venta" class="form-control" value="<?= htmlspecialchars($producto['precio_venta']); ?>" required>
    </div>
