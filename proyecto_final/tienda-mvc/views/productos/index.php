...
<table class="table table-bordered table-striped">
    ...
    <tbody>
        <!-- /* Este bloque de código PHP es un bucle foreach que itera sobre un 
        array de `` y genera una fila de tabla `<tr>` para cada producto del array. Dentro 
        de cada fila, muestra diversos detalles del producto, como ID, SKU, nombre, 
        precio de compra, precio de venta y cantidad en stock. Cantidad. */ -->
