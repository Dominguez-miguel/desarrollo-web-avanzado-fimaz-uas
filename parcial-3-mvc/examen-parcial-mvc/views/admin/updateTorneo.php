        ...
        <div class="card body">
            <form action="torneoUpdate.php" method="post">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="txtPatrocinador" id="patrocinadores" cols="30" rows="2" class="form-control" > <?= $lstTorneo['patrocinadores'] ?> </textarea>
                ...
                <div class="row">
                    ...
                    <div class="col mb-3">
                        ...
                        <input list="lstCategorias" name="txtCategoria" id="categoria" class="form-control" value="<?= $lstTorneo['categoria'] ?>" >
                    </div>
                </div>
