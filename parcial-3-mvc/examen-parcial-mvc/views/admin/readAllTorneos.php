                        ...
                        <?php if($rows): ?>
                            <?php foreach($rows as $row): ?>
                                <tr>
                                    ...
                                    <th>
                                        <a href="readOneTorneo.php?id=<?= $row['id'] ?>" class= "btn btn-primary"><span class="fa-solid fa-clipboard-list"></span></a>
                                        <a href="updateTorneo.php?id=<?= $row['id'] ?>" class= "btn btn-success"><span class="fa-solid fa-pen"></span></a>
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="deleteTorneo.php?id=<?= $row['id'] ?>" class="btn btn-danger">Elminar</a>
                                            </div>
                                            </div>
                                        </div>
                                        </div>
